...
<div class="row">
    <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th>@sortablelink('product_id', __('views.admin.purchase.order.lines.index.table_header_0'),['page' =>
                    $purchaseOrderLines->currentPage()])</th>
                <th>@sortablelink('qty', __('views.admin.purchase.order.lines.index.table_header_1'),['page' =>
                    $purchaseOrderLines->currentPage()])</th>
                <th>@sortablelink('price', __('views.admin.purchase.order.lines.index.table_header_2'),['page' =>
                    $purchaseOrderLines->currentPage()])</th>
                <th>@sortablelink('discount', __('views.admin.purchase.order.lines.index.table_header_3'),['page' =>
                    $purchaseOrderLines->currentPage()])</th>
                <th>@sortablelink('total', __('views.admin.purchase.order.lines.index.table_header_4'),['page' =>
                    $purchaseOrderLines->currentPage()])</th>
                <th>@sortablelink('created_at', __('views.admin.purchase.order.lines.index.table_header_5'),['page' =>
                    $purchaseOrderLines->currentPage()])</th>
                <th>@sortablelink('updated_at', __('views.admin.purchase.order.lines.index.table_header_6'),['page' =>
                    $purchaseOrderLines->currentPage()])</th>
                <th>Actions</th>
            </tr>
        </thead>
